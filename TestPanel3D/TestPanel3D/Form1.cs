...
namespace TestPanel3D
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            panel1.addACP3D();
            panel1.addACP3DPoints(new Vector3(0.1f, 0.5f, -0.1f), "X1");
            panel1.addACP3DPoints(new Vector3(-0.3f, -0.5f, 0.1f), "X2");
            panel1.addACP3DPoints(new Vector3(-0.4f, 0.3f, -0.4f), "X3");
            panel1.addACP3DPoints(new Vector3(0.5f, 0.1f, 0.9f), "X4");
            panel1.addACP3DPoints(new Vector3(0.6f, -0.9f, -0.2f), "X5");
            panel1.addACP3DPoints(new Vector3(0.1f, 0.9f, 0.9f), "X6");


            panel1.addACP3DVector(new Vector3(0.2f, -0.1f, 0.7f), "direction 1");
            panel1.addACP3DVector(new Vector3(0.8f, -0.4f, -0.2f), "direction 2");
            panel1.addACP3DVector(new Vector3(-0.6f, 0.3f, 0.4f), "direction 3");
            panel1.addACP3DVector(new Vector3(-0.2f, 0.3f, 0.1f), "direction 4");
